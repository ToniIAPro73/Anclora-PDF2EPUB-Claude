...
const FileUploader: React.FC<FileUploaderProps> = ({
  ...
  const dropzoneClasses = useMemo(() => {
    ...
    const baseClasses = "relative overflow-hidden border-2 border-dashed transition-all duration-300 cursor-pointer file-uploader-card";
  ...
  const dropzoneStyles = useMemo(() => {
    ...
    if (isDragActive) {
      ...
      styles.borderColor = "rgba(255, 255, 255, 0.28)";
    ...
    <Container>
      ...
      >
        ...
        {!file && !error && !isUploading && (
          ...
          <div className="flex flex-col items-center justify-center py-12 px-6 text-center file-uploader-card">
        ...
        {file && !error && !isUploading && !isAnalyzing && (
          ...
          <div className="flex items-center justify-between py-6 px-6 file-uploader-card">
